...
class Incidente(Base):
    """Modelo de Incidente con SQLAlchemy - Relación N:1 con Ticket."""
    ...
    # Foreign Key - Muchos incidentes pertenecen a un ticket
    ticket_id = Column(Integer, ForeignKey('tickets.id'), nullable=False)
    
    # Relación N:1 - Muchos incidentes pertenecen a un ticket
